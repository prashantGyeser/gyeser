...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { category: @menu_item.category, description: @menu_item.description, name: @menu_item.name, price: @menu_item.price }
    end
  ...
  test "should update menu_item" do
    put :update, id: @menu_item, menu_item: { category: @menu_item.category, description: @menu_item.description, name: @menu_item.name, price: @menu_item.price }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
